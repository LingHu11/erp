...
public class GoodsController {
    ...
    public ModelAndView findAll(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "4") Integer size, String whichpage) throws Exception {
        //为0说明是要进行商品转赠品
        ...
        try {
          ...
          throw new MyException(MyException.getStackTrace(e));
        }
        return mv;
    }
    ...
    public ModelAndView findById(Integer id, String page) {
