...
public class AReturnStorage {
    ...
    public String getOpinionAudit() {
        return opinionAudit;
    }

    public void setOpinionAudit(String opinionAudit) {
        this.opinionAudit = opinionAudit == null ? null : opinionAudit.trim();
    }
