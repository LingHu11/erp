...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 内容头部 /-->
        <form class="form-horizontal" action="${pageContext.request.contextPath}/roleuser/add"
              method="post">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <input type="text" class="form-control" id="realName" value="${param.realName}">
                    </div>
                    <div class="col-xs-2">
                        <select class="form-control" id="roleName" name="roleId" value="">
                            <option value="-1">--- 所属角色 ---</option>
                        </select>
                    </div>
                    <button type="submit" class="btn btn-info pull-left" style="margin-right: 15px">添加
                    </button>
                </div>
            </div>
        </form>
