        ...
        <section class="content">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <a class="btn btn-info pull-left"
                                   href="${pageContext.request.contextPath}/pages/goods/goods-add.jsp">新建</a>
                                <!--工具栏-->
            ...
            <div class="box-footer">
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        <li>
                            <a href="${pageContext.request.contextPath}/permission/list?page=1&size=${pageInfo.pageSize}"
                               aria-label="Previous">首页</a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/permission/list?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                        </li>
                        <c:forEach begin="1" end="${pageInfo.pages}" var="currentPage">
                            <li>
                                <a href="${pageContext.request.contextPath}/permission/list?page=${currentPage}&size=${pageInfo.pageSize}">${currentPage}</a>
                            </li>
                        </c:forEach>
                        <li>
                            <a href="${pageContext.request.contextPath}/permission/list?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/permission/list?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        location.href = "${pageContext.request.contextPath}/permission/list?page=1&size=" + pageSize;
    }
