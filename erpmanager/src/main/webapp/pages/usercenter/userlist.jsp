                                    ...
                                    <div class="form-group form-inline">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-default" title="新建"
                                                    onclick='location.href="${pageContext.request.contextPath}/pages/usercenter/adduser.jsp"'><i
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        ...
                        <c:forEach begin="1" end="${pageInfo.pages}" var="currentPage">
                            <li>
                                <a href="${pageContext.request.contextPath}/user/list?page=${currentPage}&size=${pageInfo.pageSize}">${currentPage}</a>
                            </li>
                        </c:forEach>
                        <li>
